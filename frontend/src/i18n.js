...
const en = {
  ...
  'charts.listing-count-time-series-district.title': 'Listing count over time by district',
  'charts.listing-count-time-series-district.yaxis': 'Listing count',
  'charts.listing-count-time-series-neighborhood.title': 'Listing count over time by neighbourhood',
  'charts.listing-count-time-series-neighborhood.yaxis': 'Listing count',
...
const de = {
  ...
  'charts.listing-count-time-series-district.title': 'Anzahl der Inserate im Zeitverlauf nach Bezirk',
  'charts.listing-count-time-series-district.yaxis': 'Anzahl Inserate',
  'charts.listing-count-time-series-neighborhood.title': 'Anzahl der Inserate im Zeitverlauf nach Viertel',
  'charts.listing-count-time-series-neighborhood.yaxis': 'Anzahl Inserate',
...
const es = {
  ...
  'charts.listing-count-time-series-district.title': 'Número de anuncios a lo largo del tiempo por distrito',
  'charts.listing-count-time-series-district.yaxis': 'Número de anuncios',
  'charts.listing-count-time-series-neighborhood.title': 'Número de anuncios a lo largo del tiempo por barrio',
  'charts.listing-count-time-series-neighborhood.yaxis': 'Número de anuncios',
...
const ar = {
  ...
  'charts.listing-count-time-series-district.title': 'عدد الإعلانات عبر الزمن حسب المنطقة',
  'charts.listing-count-time-series-district.yaxis': 'عدد الإعلانات',
  'charts.listing-count-time-series-neighborhood.title': 'عدد الإعلانات عبر الزمن حسب الحي',
  'charts.listing-count-time-series-neighborhood.yaxis': 'عدد الإعلانات',
...
const tr = {
  ...
  'charts.listing-count-time-series-district.title': 'İlçeye göre zaman içinde ilan sayısı',
  'charts.listing-count-time-series-district.yaxis': 'İlan sayısı',
  'charts.listing-count-time-series-neighborhood.title': 'Mahalleye göre zaman içinde ilan sayısı',
  'charts.listing-count-time-series-neighborhood.yaxis': 'İlan sayısı',
